...
from .views import TeamListView, TeamDetailView, PlayerListView, MatchListView, MatchDetailView, RatingCreateView, VoteCreateView, PronosticCreateView, PronosticListView
